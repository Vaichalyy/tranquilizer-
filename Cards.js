    ...
    <CRow>
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>What is Separation Anxiety?</strong>
          </CCardHeader>
          <CCardBody>
          <p className="text-medium-emphasis small">
          Separation anxiety is a type of anxiety disorder that is characterized by an excessive fear or 
          distress when an individual is separated from a person or place that provides a sense of security or 
          comfort. Separation anxiety can occur in both children and adults, and it can manifest in various ways.
          </p>

          <p className="text-medium-emphasis small">
          In children, separation anxiety is a normal part of development and can occur when they are separated from 
          their primary caregiver or home environment. It usually peaks between the ages of 8 and 14 months and 
          begins to diminish around age 2. Children with separation anxiety may exhibit clingy or whiny behavior, excessive crying, 
          fear of being alone, or reluctance to attend school or other activities.
          </p>

          <p className="text-medium-emphasis small">
          In adults, separation anxiety can manifest as a fear of being alone, fear of losing a loved one, or fear of leaving home. 
          Adults with separation anxiety may experience physical symptoms such as sweating, nausea, or trembling when faced with 
          separation from a loved one or a place that provides comfort and security
          </p>

          <p className="text-medium-emphasis small">
          Treatment for separation anxiety may involve cognitive-behavioral therapy (CBT), exposure therapy, and medications 
          such as antidepressants or anti-anxiety medications. With appropriate treatment, many people with separation anxiety 
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>How to Prevent Separation Anxiety?</strong>
          </CCardHeader>
          <CCardBody>
          <p className="text-medium-emphasis small">
          It may not always be possible to prevent separation anxiety, as it can arise from a variety of factors such as 
          genetics, past experiences, or learned behaviors. However, there are some steps that may help reduce the risk of 
          developing separation anxiety:
          </p>

          <p className="text-medium-emphasis small">
          Build secure attachments: Building secure attachments between caregivers and children can help reduce the risk of 
          separation anxiety in children. Providing a safe and nurturing environment, responding consistently to a child's 
          needs, and building trust can help children develop a sense of security.
          </p>

          <p className="text-medium-emphasis small">
          Encourage independence: Encouraging children to develop a sense of independence can help reduce the risk of separation 
          anxiety. Gradually introducing new experiences and encouraging children to take small risks can help build confidence and resilience.
          </p>

          <p className="text-medium-emphasis small">
          Practice separation gradually: Gradual exposure to separation can help reduce the risk of separation anxiety in both children 
          and adults. Starting with short periods of separation and gradually increasing the time can help build tolerance and reduce anxiety.
          </p>

          <p className="text-medium-emphasis small">
          Seek professional help: If you or a loved one is experiencing symptoms of anxiety or separation anxiety, it is important to 
          seek professional help from a mental health professional who can provide appropriate treatment and support.
          </p>
      ...
      {/* <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>Panic</strong> <small>Disorder</small>
          </CCardHeader>
          <CCardBody>
            <p className="text-medium-emphasis small">
